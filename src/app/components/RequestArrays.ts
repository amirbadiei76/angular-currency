...
export class RequestArray {
    ...
    setupCryptoList(current: Current) {
        ...
        this.cryptoList.push({
            ...
            groupName: CRYPTO_PREFIX,
            unit: dollar_unit,
            img: '/assets/images/crypto-icons/shiba_inu2.png'
        });
        this.cryptoList.push({
            id: "1000152",
        ...
        this.cryptoList.push({
            ...
            groupName: CRYPTO_PREFIX,
            unit: dollar_unit,
            img: '/assets/images/crypto-icons/ftm.png'
        });
        this.cryptoList.push({
            id: "1000162",
            ...
            groupName: CRYPTO_PREFIX,
            unit: dollar_unit,
            img: '/assets/images/crypto-icons/egld.png'
        });
        this.cryptoList.push({
            id: "1000163",
        ...
        this.cryptoList.push({
            ...
            groupName: CRYPTO_PREFIX,
            unit: dollar_unit,
            img: '/assets/images/crypto-icons/flow.png'
        });
        this.cryptoList.push({
            id: "1000167",
            ...
            groupName: CRYPTO_PREFIX,
            unit: dollar_unit,
            img: '/assets/images/crypto-icons/gala.png'
        });
        this.cryptoList.push({
            id: "1000168",
        ...
        this.cryptoList.push({
            ...
            groupName: CRYPTO_PREFIX,
            unit: dollar_unit,
            img: '/assets/images/crypto-icons/cakeswap.png'
        });
        this.cryptoList.push({
            id: "1000170",
        ...
        this.cryptoList.push({
            ...
            groupName: CRYPTO_PREFIX,
            unit: dollar_unit,
            img: '/assets/images/crypto-icons/cashaa.png'
        });
        this.cryptoList.push({
            id: "1000174",
    ...
    setupPreciousMetals(current: Current) {
    ...
    setupBaseMetals(current: Current) {
        this.baseMetalList = []
    ...
    setupCommodityMarket(current: Current) {
        this.commodityList = []
