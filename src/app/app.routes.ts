...
export const routes: Routes = [
    ...
    { path: 'gold-calculator', loadComponent: () => import('../app/pages/gold-calculator/gold-calculator.component').then((gold) => gold.GoldCalculatorComponent), title: 'محاسبه‌گر طلا' },
