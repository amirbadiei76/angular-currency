...
export const routes: Routes = [
    ...
    { path: ':title', pathMatch: 'full', loadComponent: () => import('../app/pages/currency-item-details/currency-item-details.component').then((item) => item.CurrencyItemDetailsComponent) },
